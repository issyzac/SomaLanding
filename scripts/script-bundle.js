!function a(b, c, d) {
    ...
    1: [function (a, b) {
        ...
        b.exports = function (a, b) {
            ...
            return !Modernizr.cssanimations || d ? (c(".scroll-in-animation").removeClass("scroll-in-animation"), void c(".scroll-animation").removeClass("scroll-animation")) : (c(".safari i.scroll-in-animation").removeClass("scroll-in-animation"), c(".safari i.scroll-animation").removeClass("scroll-animation"), void a.find(".scroll-in-animation, .scroll-animation").each(function () {
                var a = c(this), d = a.data("delay"), e = a.data("animation") + " animated css-animation-show", f = function () {
    ...
    3: [function (a, b) {
        ...
        b.exports = function (b) {
            var d = this, e = (a("../tools/tools.js"), a("../app/scroll-animation.js")), f = c(window), g = (c("html").hasClass("poor-browser"), new e(d, b));
    ...
    4: [function (a, b) {
        ...
        var c = jQuery;
        b.exports = function () {
            var b = (a("../app/app-share.js"), c("html").hasClass("poor-browser")), d = 4e3, e = 12e3, f = {scale: 1}, g = {scale: 1.1}, h = [[f, g], [g, f]], i = [{
                or: "left top",
                xr: 0,
                yr: 0
                ...
                xr: 2,
                yr: 1
            }], j = h.length - 1, k = i.length - 1, l = TWEEN.Easing.Quartic.InOut, m = TWEEN.Easing.Linear.None;
            this.run = function (a) {
                function f(b, n) {
                    var o = a.get(b), p = c(o), q = p.data(), r = Math.round(Math.random() * j), s = Math.round(Math.random() * k), t = h[r];
    ...
    6: [function (a, b) {
        ...
        b.exports = new function () {
            ...
            var d, e = a("./app-share.js"), f = a("./themes.js"), g = a("../animation/slide-show.js"), h = new g, i = c("html").hasClass("poor-browser"), j = c("html").hasClass("mobile"), k = 60, l = c("#top-nav, .page-border, #dot-scroll"), m = c("#top-nav"), n = m.data("state1-colors"), o = m.data("state2-colors"), p = c("body"), q = c(".view");
            this.prepare = function (a) {
                ...
                d.each(function () {
                    ...
                    var i = h.normalX + h.zoomXDelta * b, j = h.normalY + h.zoomYDelta * d + (void 0 !== h.parallaxY ? h.parallaxY : 0), k = h.normalScale * (void 0 !== h.ssScale ? h.ssScale : 1);
                ...
                var f = c(window), g = f.height(), h = f.width(), i = c("#top-nav:visible"), j = g - (i.length > 0 ? a.topNav.state2H : 0), k = c(".page-border.bottom:visible"), l = k.length > 0 ? k.height() : 0;
                c(".full-size, .half-size, .one-third-size").each(function () {
                    var a = c(this), b = parseInt(a.css({"padding-top": ""}).css("padding-top").replace("px", "")), d = parseInt(a.css({"padding-bottom": ""}).css("padding-bottom").replace("px", "")), e = j - (k.length > 0 ? l : 0), f = Math.ceil(e / 2), g = Math.ceil(e / 3), h = a.hasClass("full-size") ? e : a.hasClass("half-size") ? f : g;
                    a.css({
                        "padding-top": b + "px",
                        "padding-bottom": d + "px"
                    ...
                    var f = c(this), h = f.find(".content"), i = h.find(".skew.skew-top-right, .skew.skew-top-left"), j = h.find(".skew.skew-bottom-left, .skew.skew-bottom-right"), k = h.width() + "px";
        ...
        b.exports = function (b) {
            ...
            function j(a, b, d, f, g, h) {
                ...
                if (k.val(j), "color" === d)k.minicolors({
                    ...
                    show: function () {
                        var a = k.parent(), b = a.children(".minicolors-panel"), d = b.outerHeight(!0), e = b.outerWidth(!0), f = c(window), g = f.width(), h = f.height(), i = b.offset(), j = i.left - c(document).scrollLeft(), l = i.top - c(document).scrollTop();
            ...
            var o, p, q, r, s, t, u, v, w = a("../app/themes.js"), x = a("../tools/tools.js"), y = a("../widgets/loading.js"), z = a("../app/app-share.js"), A = w.colors, B = this, C = "", D = c(window), E = !1;
    ...
    14: [function (a, b) {
        ...
        b.exports = function (a, b) {
            ...
            d || a.find(".counter .count").each(function () {
                var a = c(this), d = parseInt(a.text()), e = {n: 0}, f = new TWEEN.Tween(e).to({n: d}, 1e3).onUpdate(function () {
    ...
    18: [function (a, b) {
        ...
        var c = jQuery;
        b.exports = new function () {
            var b = a("../tools/tools.js"), d = c(".gate"), e = d.find(".gate-bar"), f = d.find(".loader"), g = c("html").hasClass("android-browser-4_3minus"), h = this;
            this.queue = [], this.load = function (a) {
                var b = [], g = c(".non-preloading, .non-preloading img");
                c("*:visible:not(script)").not(g).each(function () {
                    var a = c(this), d = a[0].nodeName.toLowerCase(), e = a.css("background-image"), f = a.attr("src"), g = a.data("loading");
        ...
        b.exports = function () {
            ...
            a.click(function (a) {
                ...
                if (b.hasClass("ext-nav-toggle")) {
                    var d = b.data("target"), e = c(d), f = c(d + ",#top-nav a:not(.menu-toggle),.page-border a"), g = function () {
    ...
    21: [function (a, b) {
        ...
        b.exports = function (a, b, d, e) {
            ...
            var g = a.find(".cross"), h = c(a.data("overlay-zoom")), i = a.find(".overlay-view"), g = a.find(".cross"), j = this;
    ...
    25: [function (a, b) {
        ...
        b.exports = function () {
            {
                var b = a("../tools/tools.js"), d = c("#top-nav"), e = c("body"), f = d.length > 0, g = d.find(".navbar-collapse"), h = 20, i = f ? 89 : 0, j = f ? 49 : 0, k = (a("../app/themes.js"), function () {
                    return f ? h : 0
                }()), l = !1, m = !1, n = this;
    ...
    26: [function (a, b) {
        ...
        b.exports = function () {
            ...
            if (!(a.length < 1)) {
                var b = function () {
                    var a = c("html").hasClass("mobile"), b = document.createElement("video"), d = b.canPlayType ? b.canPlayType("video/mp4") : !1;
                    return d && !a
                }();
                ...
                a.each(function (a) {
                    ...
                    a.each(function () {
                        var a = c(this), d = a.attr("id"), e = function () {
                            var b = a.data("volume");
                            return void 0 === b ? 0 : b
                        }(), f = a.data("video"), g = c('<iframe class="vimeo-bg" src="https://player.vimeo.com/video/' + f + "?api=1&badge=0&byline=0&portrait=0&title=0&autopause=0&player_id=" + d + '&amp;loop=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
                        a.after(g), a.remove(), g.attr("id", d);
                        var h = $f(g[0]);
                        h.addEvent("ready", function () {
                            var a = function (a) {
                                var b = c(window).width(), d = c(window).height(), e = g.width(), f = g.height(), h = e / f, i = b / d, j = function (c, e) {
                                    var f, i;
